...
"""
Usage:
1. Put All the label files in one floder, and all the dict files in another floder(can't be the same floder)
	Please Name the label and fict files from same dataset with the same number suffix,For example:
